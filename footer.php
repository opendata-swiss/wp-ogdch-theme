	...
	<div class="row">
		<div class="col-sm-3 col-xs-6">
			<a href="<?php echo esc_url( get_page_link_by_slug( 'dataset' ) ); ?>">
				<div class="statsnumber">
					<?php esc_html_e( number_format_de( $dataset_count['total_count'] ) ); ?> <i class="fa fa-files-o"></i>
				</div>
		...
		<div class="col-sm-3 col-xs-6">
			<a href="<?php echo esc_url( get_page_link_by_slug( 'organization' ) ); ?>">
				<div class="statsnumber">
					<?php esc_html_e( number_format_de( wp_count_posts( 'ckan-local-org' )->publish ) ); ?> <i class="fa fa-users"></i>
				</div>
		...
		<div class="col-sm-3 col-xs-6">
			<a href="<?php echo esc_url( get_page_link_by_slug( 'app' ) ); ?>">
				<div class="statsnumber">
					<?php esc_html_e( number_format_de( get_localized_post_count( 'app' ) ) ); ?> <i class="fa fa-puzzle-piece"></i>
				</div>
		...
		<div class="col-sm-3 col-xs-6">
			<a href="https://twitter.com/OpendataCH" target="_blank">
				<div class="statsnumber">
					<?php esc_html_e( number_format_de( get_tweet_count() ) ); ?> <i class="fa fa-twitter"></i>
				</div>
